...
{
    /**
     * Menampilkan daftar semua borang
     */
    public function index()
    {
        $borangs = DB::table('accreditation_borangs')
            ...
            ->select([
                ...
                'standard_indicators.indicator_code', // PASTIKAN NAMA KOLOM INI BENAR DI DB
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('accreditation_borangs.index')
                         ->with('success', 'Data Borang berhasil disimpan!');
    }

    /**
     * Menampilkan detail borang (Opsional)
     */
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('accreditation_borangs.index')
                         ->with('success', 'Data Borang berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('accreditation_borangs.index')
                         ->with('success', 'Data Borang berhasil dihapus!');
    }
}